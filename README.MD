...
## DevOps Demo
- docker tag flaskr freefox1.jfrog.io/docker-devops/python-flask-sample-app:v1.0.0
- docker push freefox1.jfrog.io/docker-devops/python-flask-sample-app:v1.0.0
